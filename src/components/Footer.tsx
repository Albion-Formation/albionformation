...
const socialLinks = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/albionformation/",
    icon: (
      <svg
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/109991858/",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  {
    name: "Facebook",
    href: "https://web.facebook.com/profile.php?id=61578079255691",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <a
              href="mailto:support@albionformation.com"
